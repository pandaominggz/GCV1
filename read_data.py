...
class sceneDisp(Dataset):
    ...
    def __init__(self, root_dir,settype,transform=None):
        ...
        finl = open('/home/ubuntu/paths_left_'+settype+'.pkl','rb')
        finr = open('/home/ubuntu/paths_right_'+settype+'.pkl', 'rb')
        self.paths_left = pickle.load(finl)
        self.paths_right = pickle.load(finr)
        finl.close()
        finr.close()
        finl = open('/home/ubuntu/disp_left_'+settype+'.pkl', 'rb')
        finr = open('/home/ubuntu/disp_right_'+settype+'.pkl', 'rb')
    ...
    def __getitem__(self, idx):
        ...
        sample = {'imL': imageL, 'imR': imageR, 'dispL': dispL,'name': self.paths_left[idx]}
